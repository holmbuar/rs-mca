...
- **Agent/model:** Codex.
- **Files added or changed:** Added `experimental/notes/audits/m1_kb_branch3_route_cut_stack_audit.md @ 941a6c4f` and `experimental/scripts/verify_m1_kb_branch3_route_cut_stack_audit.py @ 85179694`; changed `experimental/notes/m1/m1_kb_branch3_rank9_mask_deficit_route_cut_v1.md @ 633ceb10`, `experimental/scripts/verify_m1_kb_branch3_rank9_mask_deficit_v1.py @ a1eada87`, `experimental/scripts/verify_m1_kb_branch3_rank9_syndrome_rank_reduction_v1.py @ 2a2e1510`, `experimental/data/certificates/m1-kb-branch3-actual-core-mds-v1/README.md @ 795e16f6`, `experimental/data/certificates/m1-kb-branch3-actual-core-mds-v1/m1_kb_branch3_actual_core_mds_v1.json @ e4128645`, `experimental/data/certificates/m1-kb-branch3-rank9-mask-deficit-v1/README.md @ b0ca6a4a`, `experimental/data/certificates/m1-kb-branch3-rank9-mask-deficit-v1/m1_kb_branch3_rank9_mask_deficit_v1.json @ ca425c11`, `experimental/data/certificates/m1-kb-branch3-rank9-syndrome-rank-reduction-v1/README.md @ 26a2e278`, and `experimental/data/certificates/m1-kb-branch3-rank9-syndrome-rank-reduction-v1/m1_kb_branch3_rank9_syndrome_rank_reduction_v1.json @ d1c8cb05`; amended this promotion entry.
- **Status:** AUDIT
- **What is being added:** AUDIT applies to the three bounded route cuts integrated at `48115af6` from PR #867 head `6ad24364`, PR #871 head `05926894`, and PR #874 head `f8d2c0cf`: their stated arithmetic, selector/restricted-map ownership units, first-match partition, and unchanged ledger are sound, and rank nine, sparse sigma, branch 3, and the KoalaBear row remain unpaid (`experimental/notes/audits/m1_kb_branch3_route_cut_stack_audit.md:15-33,163-201,237-243 @ 941a6c4f`). Two machine-interface defects, not payment counterexamples, were repaired: the original generic one-cut statement and helper both lacked the necessary predecessor coarse-failure window and accepted `N_V=1699344,d_V=1,D=0`, producing `sharp_bad_high_count=-1` (`experimental/notes/m1/m1_kb_branch3_rank9_mask_deficit_route_cut_v1.md:334-410 @ 96e6a797`; `experimental/scripts/verify_m1_kb_branch3_rank9_mask_deficit_v1.py:477-525 @ 008dc0f5`), while the original certificate/verifier called `CORRELATED_AGREEMENT_ROUTE_TO_SPARSE_SIGMA` an owner despite the note declaring it an unpaid route (`experimental/notes/m1/m1_kb_branch3_rank9_syndrome_rank_reduction_v1.md:340-379,404-426 @ 2a44f8a8`; `experimental/data/certificates/m1-kb-branch3-rank9-syndrome-rank-reduction-v1/m1_kb_branch3_rank9_syndrome_rank_reduction_v1.json:20-66 @ 7a2cc953`; `experimental/scripts/verify_m1_kb_branch3_rank9_syndrome_rank_reduction_v1.py:548-550,574-590 @ f9de7df9`); the three replay READMEs were also changed to check certificate freshness before regeneration (`experimental/notes/audits/m1_kb_branch3_route_cut_stack_audit.md:153-161 @ 941a6c4f`), and independent reproduction and repaired correspondence are pinned in `experimental/scripts/verify_m1_kb_branch3_route_cut_stack_audit.py:108-165,231-289 @ 85179694`.
