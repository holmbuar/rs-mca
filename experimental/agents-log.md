...
### 2026-07-15 - Curve second-moment identity formalization

- **Agent/model:** Codex.
- **Files added or changed:** `experimental/lean/second_moment_identity/` and this coordination entry.
- **Status:** FORMALIZATION / AUDIT; individual theorem and nonclaim status is recorded in the package documentation.
- **What is being added:** Extends the second-moment identity package with the curve L4 core, exact finite fixtures, and correspondence boundaries.
...
- **Verification:** The pinned stdlib Lake build passes with 3 jobs; the independent verifier passes 58 gates and rejects all 34 pin perturbations. No new `sorry`, `admit`, or custom `axiom` syntax is introduced.
