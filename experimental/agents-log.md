...
### 2026-07-18 - Triple-negative first-match correspondence audit

- **Agent/model:** Codex.
- **Files added or changed:** `experimental/notes/audits/triple_negative_first_match_correspondence_audit.md` @ `8906f892`; `experimental/scripts/verify_triple_negative_first_match_correspondence_audit.py` @ `6d0426e3`; `experimental/notes/thresholds/triple_negative_first_match_reduction.md` @ `656679fc`; `experimental/scripts/verify_triple_negative_first_match_reduction.py` @ `f5f76c7a`; `experimental/data/certificates/triple-negative-first-match-reduction/triple_negative_first_match_reduction.json` @ `4ce4d1b9`.
- **Status:** COUNTEREXAMPLE
- **What is being added:** At integration `168e9ba0`, PR #829 head `abdef3be` advertised a replay/provenance claim at `experimental/notes/thresholds/triple_negative_first_match_reduction.md:405-430` @ `85aafd67` that was false: `experimental/scripts/verify_triple_negative_first_match_reduction.py:33-39` @ `3f52f78a` required a retired marker and `experimental/data/certificates/triple-negative-first-match-reduction/triple_negative_first_match_reduction.json:751-764` @ `863b3b1d` pinned its old line and full hash, although same-wave PR #832 head `402b2703` had replaced it at `experimental/notes/thresholds/all_pair_paving_basis_multiplicity_compiler.md:487-512` @ `d1a961a4`; the producer also called PR #817 head `5c4c6a42` pending at `experimental/notes/thresholds/triple_negative_first_match_reduction.md:33-36,63-66,459` @ `85aafd67` although same-wave PR #823 head `06c06581` integrated its superset. `experimental/notes/audits/triple_negative_first_match_correspondence_audit.md:16-73` @ `8906f892` and `experimental/scripts/verify_triple_negative_first_match_correspondence_audit.py:390-562` @ `6d0426e3` independently establish the `COUNTEREXAMPLE`: all four advertised replays failed, while the arithmetic theorem and `experimental/lean/grande_finale/GrandeFinale/TripleNegativeFirstMatchReduction.lean:1-256` @ `75d3cf90` are clean.
- **How it is useful:** The repair restores source-to-verifier/certificate correspondence and adopts PR #832 head `402b2703`'s exact deep-hole pencil/design residual at `experimental/notes/thresholds/augmented_basis_pencil_design_inverse.md:14-33,125-139` @ `fc999923`; producer interlocks remain PR #741 head `299e8160`, PR #764 head `4085f048`, PR #771 head `e94d78f5`, PR #823 head `06c06581` covering PR #817 head `5c4c6a42`, PR #829 head `abdef3be`, and PR #832 head `402b2703`. The only integrated Lean consumer is `experimental/lean/grande_finale/GrandeFinale.lean:42` @ `7be790f2`, and open PR #882 head `af213091` is transitive only; the separate package-map overstatement at `experimental/lean/grande_finale/README.md:30-31` @ `bed5976f` and `experimental/lean/grande_finale/FORMALIZATION_SUMMARY.md:21-22` @ `d1c3e0ed` remains explicitly out of scope.
- **What to do next:** Run `python3 experimental/scripts/verify_triple_negative_first_match_correspondence_audit.py` and `python3 -O experimental/scripts/verify_triple_negative_first_match_correspondence_audit.py` (the verifier is `experimental/scripts/verify_triple_negative_first_match_correspondence_audit.py` @ `6d0426e3`) and expect `RESULT: PASS (16/16)` followed by `STATUS: COUNTEREXAMPLE`; then run `python3 experimental/scripts/verify_triple_negative_first_match_reduction.py --check` and `python3 -O experimental/scripts/verify_triple_negative_first_match_reduction.py --check` (the producer is `experimental/scripts/verify_triple_negative_first_match_reduction.py` @ `f5f76c7a`) and expect `triple-negative-first-match-reduction: PASS` with payload `a8c0ae04007b364cb7d47ec6f04b0985399a18b7a70ab159698dca6aca3e024d`; keep counting/first-match promotion and the two package-map repairs separate.
