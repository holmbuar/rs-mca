...
### 2026-07-18 - Rank-one admission prose/source correspondence audit

- **Agent/model:** Codex.
- **Files added or changed:** Added `experimental/notes/audits/rank_one_admission_prose_correspondence_audit.md @ d2380a78` and `experimental/scripts/verify_rank_one_admission_prose_correspondence_audit.py @ cac55bfc`; repaired `experimental/notes/audits/rank_one_admission_interface_audit.md @ fe3e33f2`, `experimental/notes/thresholds/rank_one_emission_arithmetic.md @ 85d685cc`, `experimental/notes/thresholds/omega_sound_emission_floor.md @ 0ae2bbd8`, `experimental/notes/thresholds/rank_one_greedy_adequacy.md @ e2a0078b`, `experimental/notes/thresholds/shell_mass_spectral_law.md @ 56fe9959`, `experimental/notes/thresholds/product_profile_transfer_certificate.md @ bb14a7f0`, `experimental/scripts/verify_rank_one_admission_interface.py @ ecf1118e`, `experimental/scripts/verify_rank_one_greedy_adequacy.py @ 4e3d902d`, `experimental/scripts/verify_omega_sound_emission_floor.py @ 07b51f11`, `experimental/lean/rank_one_greedy_adequacy/RankOneGreedyAdequacy.lean @ d364fc46`, and `experimental/lean/omega_sound_emission_floor/OmegaSoundEmissionFloor.lean @ daabb397`; regenerated `experimental/data/certificates/rank-one-admission-interface/rank_one_admission_interface.json @ 4a632f9f`, `experimental/data/certificates/rank-one-greedy-adequacy/rank_one_greedy_adequacy.json @ d1b4b3ea`, and `experimental/data/certificates/omega-sound-emission-floor/omega_sound_emission_floor.json @ 3b63ebde`; amended this promotion entry.
- **Status:** COUNTEREXAMPLE
- **What is being added:** At upstream `c4856fa6`, COUNTEREXAMPLE applies specifically to PR #866 head `0b45db15` claiming `"grammar acceptance alone remains": OPEN GAP / FIXED IN PROSE` in `experimental/notes/audits/rank_one_admission_interface_audit.md:19-23 @ d46c6263`: PR #818 head `03fa2958` retained grammar-only admission wording in `experimental/notes/thresholds/rank_one_emission_arithmetic.md:57-63,292-309,323-341 @ 03df4497`, PR #820 head `d5f67b4b` retained pure-grammar/compiler-sound wording in `experimental/notes/thresholds/omega_sound_emission_floor.md:46-50,179-188,225-227,238-253 @ 8d8f9b04`, and consumers PR #827 head `1512ff45` / PR #842 head `ea8318ff` retained the same incomplete residual in `experimental/notes/thresholds/shell_mass_spectral_law.md:51-52 @ be949c19` / `experimental/notes/thresholds/product_profile_transfer_certificate.md:44-51,209-211 @ 6365c949`; this is a counterexample only to repair completeness and source-to-verifier correspondence, not to T4, S4, the Walsh inequality, the omega cap, or any finite scan.
- **How it is useful:** It prevents local scalar accounting from being promoted as grammar admission and repairs the known integrated chain from PR #818 head `03fa2958`, PR #820 head `d5f67b4b`, PR #824 head `2f5162fc`, PR #827 head `1512ff45`, PR #842 head `ea8318ff`, and PR #866 head `0b45db15` by explicitly retaining an actual same-owner first-match cell, A4 analytic/Sidon payment, separate A6/RC distinct-slope bound, and uniform subexponential aggregate census; `PRE_REPAIR_UPSTREAM`, `INTEGRATION_COMMITS`, `HISTORIC_MANIFEST_SHA256`, `PINNED_PATHS`, `POST_REPAIR_PINS`, `HISTORIC_EVIDENCE`, `historic_manifest_sha256`, `check_historic_table`, `check_note_boundaries`, and `check_lean_scope` in `experimental/scripts/verify_rank_one_admission_prose_correspondence_audit.py:45-493,576-990 @ cac55bfc` source-bind fourteen repaired notes/verifiers/certificates/Lean files by Git blob SHA-1 plus SHA-256; the canonical historic-manifest SHA-256 pins pre-repair `c4856fa6`, integrations `168e9ba0` / `06b2a6fb`, all PR/head/blob/digest/excerpt literals, producer-head/integration/upstream path correspondence, recomputed dual digests, and byte-exact excerpts, while the `STATUS`, `Immutable pre-repair pins`, `MUST`, and `Nonclaims` sections in `experimental/notes/audits/rank_one_admission_prose_correspondence_audit.md:3-151 @ d2380a78` record the exact immutable evidence and nonclaims.
- **What to do next:** Replay `python3 experimental/scripts/verify_rank_one_admission_prose_correspondence_audit.py` and `python3 -O experimental/scripts/verify_rank_one_admission_prose_correspondence_audit.py` (`experimental/scripts/verify_rank_one_admission_prose_correspondence_audit.py @ cac55bfc`), each expecting `RESULT: PASS (368/368)` then `STATUS: COUNTEREXAMPLE`; replay `python3 experimental/scripts/verify_rank_one_admission_prose_correspondence_audit.py --tamper-selftest` and `python3 -O experimental/scripts/verify_rank_one_admission_prose_correspondence_audit.py --tamper-selftest` (`experimental/scripts/verify_rank_one_admission_prose_correspondence_audit.py @ cac55bfc`), each expecting `TAMPER SELFTEST: PASS (10/10 caught)` then `STATUS: COUNTEREXAMPLE`; independently replay `python3 experimental/scripts/verify_rank_one_admission_interface.py` (`experimental/scripts/verify_rank_one_admission_interface.py @ ecf1118e`) expecting `PASS: 46,644 universal Walsh checks over 6,662 exact cube functions`, `python3 experimental/scripts/verify_rank_one_greedy_adequacy.py` (`experimental/scripts/verify_rank_one_greedy_adequacy.py @ 4e3d902d`) expecting `RESULT: PASS (19/19)`, and `python3 experimental/scripts/verify_omega_sound_emission_floor.py` (`experimental/scripts/verify_omega_sound_emission_floor.py @ 07b51f11`) expecting `RESULT: PASS (12/12)`; `cd experimental/lean/rank_one_greedy_adequacy && lake build` (source `experimental/lean/rank_one_greedy_adequacy/RankOneGreedyAdequacy.lean @ d364fc46`) and `cd experimental/lean/omega_sound_emission_floor && lake build` (source `experimental/lean/omega_sound_emission_floor/OmegaSoundEmissionFloor.lean @ daabb397`) must each end `Build completed successfully.`
