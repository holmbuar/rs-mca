...
### 2026-07-18 - Balanced-core atlas consumer correspondence audit

- **Agent/model:** Codex.
- **Files added or changed:** `experimental/notes/audits/balanced_core_atlas_consumer_audit.md` @ blob `45fdcea6`; `experimental/scripts/verify_balanced_core_atlas_consumer_audit.py` @ blob `ec1eaa48`; `experimental/scripts/verify_atlas_cat_ledger.py` @ blob `2d589074`; `experimental/notes/thresholds/atlas_cat_cell_ledger.md` @ blob `4f4dc860`; `experimental/data/certificates/atlas-cat-ledger/atlas_cat_ledger.json` @ blob `bb2cb548`; `experimental/scripts/verify_kappa_growth.py` @ blob `75d1c8eb`; `experimental/scripts/verify_a4_coverage.py` @ blob `20208550`; `experimental/notes/thresholds/mi_ma_sidon_route_audit.md` @ blob `809973e2`; `experimental/notes/thresholds/pte_extremality_image_face.md` @ blob `6df5ac80`; `experimental/scripts/verify_pte_extremality.py` @ blob `238490e4`.
- **Status:** COUNTEREXAMPLE
- **What is being added:** The `COUNTEREXAMPLE` is to two integrated correspondence claims, not to the corrected shortening law, conditional atlas row, or conditional Lean route. First, integration `c23dcaa0` (= PR #713 head `d78ea57e`) required the retired PR #534 head `e9aca0c5` residual label at `experimental/scripts/verify_atlas_cat_ledger.py:248-279` @ blob `7ec72f21`; after integration `06b2a6fb` (= PR #868 head `5055340d`) corrected the producer boundary, the advertised atlas command failed `218/219` in normal and optimized Python, while the unconsumed `experimental/data/certificates/atlas-cat-ledger/atlas_cat_ledger.json:6-12,92-100` @ blob `37c8357a` still claimed `PASS 219/219` and `all_pass: true`. Second, integration `d287e1d2` (= PR #534 head `e9aca0c5` and PR #535 head `114f845a`) promoted raw prefix-support families and member counts to actual first-match residual charts and realized slopes in `experimental/scripts/verify_kappa_growth.py:6-24,233-240,282-329` @ blob `c0d2e216` and `experimental/scripts/verify_a4_coverage.py:6-35,226-263,292-385` @ blob `4e361545`; the deterministic witness and repaired scope are recorded at `experimental/notes/audits/balanced_core_atlas_consumer_audit.md:9-76` @ blob `45fdcea6`.
- **How it is useful:** The repair makes the atlas verifier consume the corrected raw-family label and bind all nine JSON rows while preserving `219/219`, and relabels the 95- and 63-gate censuses without changing their finite arithmetic. Producer/consumer interlocks are PR #518 head `c4f55508`, PR #528 head `12f68ecc`, PR #534 head `e9aca0c5`, PR #535 head `114f845a`, PR #564 head `96f0698a`, PR #623 head `c2027dc6`, PR #681 head `af46e334`, PR #686 head `db160c6f`, PR #713 head `d78ea57e`, PR #727 head `c6d09aed`, PR #782 head `34f91bd6`, and PR #868 head `5055340d`. The conditional Lean consumer `experimental/lean/asymptotic_spine/AsymptoticSpine/HighKappaCoverage.lean` @ blob `cdb17177` remains clean; the hash-frozen claims in `experimental/notes/roadmaps/b2_l1_reduction_ledger.md:91-101` @ blob `06d7736d` and `experimental/notes/thresholds/a6_actual_witness_core_rank_preflight.md:1420-1432` @ blob `01d53744` remain stale and outside this repair.
- **What to do next:** Review before using PR #713 head `d78ea57e` as C8 promotion evidence, and keep the PR #564 head `96f0698a` / PR #681 head `af46e334` hash-frozen claims out of promotion until their owners refresh prose and certificate hashes together. Run `python3 experimental/scripts/verify_balanced_core_atlas_consumer_audit.py` and `python3 -O experimental/scripts/verify_balanced_core_atlas_consumer_audit.py` (script @ blob `ec1eaa48`) -> `RESULT: PASS (22/22)` and `STATUS: COUNTEREXAMPLE`; run `python3 experimental/scripts/verify_atlas_cat_ledger.py --check` and its `python3 -O` form (script @ blob `2d589074`) -> `RESULT: PASS (219/219)`, and both `--tamper-selftest` modes -> `RESULT: PASS (4/4)`; run `python3 experimental/scripts/verify_kappa_growth.py` (script @ blob `75d1c8eb`) -> `RESULT: PASS (95 checks)`, `python3 experimental/scripts/verify_a4_coverage.py` (script @ blob `20208550`) -> `RESULT: PASS (63 checks)` with `kappas seen: [4, 5, 6]`, and their `python3 -O` forms identically. From the package containing `experimental/lean/asymptotic_spine/lakefile.lean` @ blob `32f74744`, run `lake build AsymptoticSpine.HighKappaCoverage` (source `experimental/lean/asymptotic_spine/AsymptoticSpine/HighKappaCoverage.lean` @ blob `cdb17177`) -> `Build completed successfully`.
