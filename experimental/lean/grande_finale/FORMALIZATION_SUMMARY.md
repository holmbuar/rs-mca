...
pinned Lean/Mathlib versions and matching precompiled Mathlib cache. The full
pinned build completed successfully on 2026-07-11 with 8038 jobs, including
`GrandeFinale.CollisionAwarePole`.
