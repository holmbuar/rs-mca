...
- **Status:** ROADMAP / AUDIT. 2026-07-06. Consolidates the CAP25 v13 (§16/17/23) reading, the
  prize-DAG structure, and the outcomes of two formalization attempts.
...
and both formalization attempts failed to prove it (honest `sorry`, no
...
Lean stack. The gap is a technique shift to arithmetic-monodromy / inverse-theorem /
