...
## Kernel and upstream verifier replay
...
The upstream PR also supplied a Python provenance verifier for the exact
declarations, source labels, Git blobs, and raw SHA-256 values.  This curated
integration keeps the Lean package and source-audit note, but intentionally
does not import the Python verifier.
...
- The upstream verifier passed `43/43` checks.  Its tamper self-test caught `13/13`
