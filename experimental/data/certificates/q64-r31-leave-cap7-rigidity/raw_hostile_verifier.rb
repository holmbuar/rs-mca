...
source = File.join(root, 'work', 'Q64_R31_MANDATORY_LEAVE_PAYMENT.md')
verifier = File.join(root, 'work', 'verify_q64_r31_mandatory_leave_payment.rb')
expected = File.join(root, 'work', 'verify_q64_r31_mandatory_leave_payment.expected.txt')
